...
def calculate_metrics(top10_indices_path, qs_as_docids, chart_qa_id_to_text, data, path, topk_scores):
    ...
    if type(docids[0]) == list:
        docids = [docid[0] for docid in docids]
        doc_names = docids.copy()
    ...
    #print(f'total = {total} nototal = {no}')
    if data == 'mp':
    ...
    question_to_guesses = {}
    recal_array = []
    for indices, docid, q, name, s in zip(top10_indices, docids, questions, doc_names, topk_scores):
        found = 0
        for i, index in enumerate(indices):
            if index == docid:
                mrr += 1 / (i + 1.0)
...
def keyword_search(chart_qa_id_to_text, qs_and_as, path, questions_train=None):
    ...
    if questions_train:
        ...
        #questions_train_real = read_pkl('/home/dzi/VisRAG.git/VisRAG/info_questions_real_train.pkl')
...
def test_hybrid(data='mp'):
    ...
    # InvoVQA
    if data == 'info':
        corpus_path = '/home/dzi/VisRAG.git/VisRAG/datasets/info_vqa/temp_files/infovqa_id_to_gpt_text.pkl'
        ...
        #path_to_dense_corpus = "/home/dzi/VisRAG.git/VisRAG/info_vqa_nvembed_gpt_descriptions_just_passage_embeddings.pkl"
        #corpus_path = '/home/dzi/VisRAG.git/VisRAG/infovqa_id_to_gpt_decriptions_fixed.pkl'
        ...
        questions_train = read_pkl('/home/dzi/VisRAG.git/VisRAG/info_questions_train.pkl')
    ...
    if data == 'mp':
        ...
        path_to_dense_embeddings = "mp_doc_vqa_nvembed_gpt_extractions_just_query_embeddings.pkl"
        path_to_dense_corpus = "mp_doc_vqa_nvembed_gpt_extractions_just_passage_embeddings.pkl"
        path_to_sparse = "mp_vqa_sparse.pkl"
        save_path = "mp_vqa_combined_nvembed.pkl"

    
    if data == 'slide':
        corpus_path = '/home/dzi/VisRAG.git/VisRAG/slide_vqa_image_to_gpt_text.pkl'
        q_and_a_path = '/home/dzi/VisRAG.git/VisRAG/slide_vqa_data_list.pkl'
        path_to_dense_embeddings = "slide_vqa_nvembed_gpt_extractions_just_query_embeddings.pkl"
        path_to_dense_corpus = "slide_vqa_nvembed_gpt_extractions_just_passage_embeddings.pkl"
        path_to_sparse = "slide_vqa_sparse.pkl"
        save_path = "slide_vqa_combined_nvembed.pkl"
...
def main():
    ...
    #corpus_path = '/home/dzi/VisRAG.git/VisRAG/chart_qa_filtered_ids_to_text_and_values.pkl'
    #q_and_a_path = "/home/dzi/VisRAG.git/VisRAG/chart_qa_qs_as_docd.pkl"

    #corpus_path = '/home/dzi/VisRAG.git/VisRAG/datasets/chart_qa/temp_data/chart_qa_filtered_ids_filled_empty_to_text_and_values.pkl'
    #q_and_a_path = "/home/dzi/VisRAG.git/VisRAG/datasets/chart_qa/temp_data/chart_qa_qs_as_docd.pkl"
    ...
    #save_path = "/home/dzi/VisRAG.git/VisRAG/datasets/chart_qa/temp_data/chart_qa_top10_englrg_text_and_values_human_filtered_filtered_corpus_added_empty.pkl"
    #save_path = "/home/dzi/VisRAG.git/VisRAG/datasets/chart_qa/temp_data/chart_qa_top10_nvembed_filtered_corpus_filled_missing.pkl"
...
def testing():
    ...
    human = get_data_from_json(f'/home/dzi/VisRAG.git/VisRAG/datasets/chart_qa/test_human.json')
    filtered_data = []
    total = 0
    inside = 0
    for h in human:
